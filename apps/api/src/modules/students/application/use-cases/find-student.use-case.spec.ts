...
import { FindStudentUseCase } from './find-student.use-case';
...
describe('FindStudentUseCase', () => {
  let useCase: FindStudentUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new FindStudentUseCase(studentRepo);
  });
  ...
  it('returns the student when found', async () => {
    ...
    const result = await useCase.execute({ studentId: 'student-1', organizationId: 'org-1' });
